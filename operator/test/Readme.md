...
```shell
opm index add \
  --bundles docker.io/xebialabsunsupported/release-operator-bundle:27.1.0 \
  --tag docker.io/xebialabsunsupported/release-operator-index:27.1 \
  --generate
```

```shell
docker build -f index.Dockerfile -t docker.io/xebialabsunsupported/release-operator-index:27.1 .
```

```shell
docker push docker.io/xebialabsunsupported/release-operator-index:27.1
```
...
opm index add \
  --bundles docker.io/xebialabsunsupported/release-operator-bundle:27.1.0 \
  --from-index docker.io/xebialabsunsupported/release-operator-index:27.1 \
  --tag docker.io/xebialabsunsupported/release-operator-index:27.1 \
  --generate
```
