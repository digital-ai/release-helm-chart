...
```shell
opm index add \
  --bundles docker.io/xebialabsunsupported/release-operator-bundle:26.3.0 \
  --tag docker.io/xebialabsunsupported/release-operator-index:26.3 \
  --generate
```

```shell
docker build -f index.Dockerfile -t docker.io/xebialabsunsupported/release-operator-index:26.3 .
```

```shell
docker push docker.io/xebialabsunsupported/release-operator-index:26.3
```
...
opm index add \
  --bundles docker.io/xebialabsunsupported/release-operator-bundle:26.3.0 \
  --from-index docker.io/xebialabsunsupported/release-operator-index:26.3 \
  --tag docker.io/xebialabsunsupported/release-operator-index:26.3 \
  --generate
```
...
```shell
docker push docker.io/xebialabsunsupported/release-operator-index:26.
```
